		...
		case '/': // Prefix: "/"
			...
			case 'a': // Prefix: "account/"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleGetAccountByIdRequest([1]string{
							args[0],
						}, elemIsEscaped, w, r)
					default:
		...
		case '/': // Prefix: "/"
			...
			case 'a': // Prefix: "account/"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "GET":
						r.name = GetAccountByIdOperation
						r.summary = "Find account by ID"
						r.operationID = "getAccountById"
						r.pathPattern = "/account/{accountId}"
						r.args = args
						r.count = 1
						return r, true
					default:
